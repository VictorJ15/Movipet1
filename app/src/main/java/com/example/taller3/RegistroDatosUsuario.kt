...
class RegistroDatosUsuario : AppCompatActivity() {
    ...
    private lateinit var binding: RegistroDatosUsuarioBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = RegistroDatosUsuarioBinding.inflate(layoutInflater)
    ...
    private fun updateUI(currentUser: FirebaseUser?) {
        if (currentUser != null) {
            val intent = Intent(this, RegistroFotoUsuario::class.java)
